...
Related Gold Standards: GS-SALES-001 Personalized SimpliBlueprint Proposal; GS-SALES-002 Personalized SimpliFoundation Proposal; GS-SALES-003 Foundation Scoping Record; GS-SALES-004 Proposal Send & Next-Step Email; GS-SALES-005 Templated WordPress Proposal; GS-SALES-006 Personalized SimpliCARE Proposal
...
# **14A. SimpliCARE Proposal Scope Object**

Before a CARE proposal may be generated, create or retrieve an approved CARE Proposal Scope Object.

Minimum fields:

CARE_Proposal_Scope_ID  
Client_ID  
Opportunity_ID  
Approved_CARE_Level  
Ongoing_Responsibility  
Business_Objective  
Marketing_Objective  
Website_and_Digital_Foundation_Responsibility  
Measurement_Responsibility  
Performance_Intelligence_Responsibility  
Discoverability_Content_Responsibility  
Optimization_Responsibility  
Partner_Coordination_Responsibility  
Reporting_Cadence  
Strategy_Cadence  
Implementation_Capacity_or_Boundary  
...
`CARE_PRICE != CARE_SCOPE`

`CARE_LEVEL != PERMISSION_TO_INFER_UNDOCUMENTED_INCLUSIONS`

`CARE_PROPOSAL_REQUIRES_APPROVED_RESPONSIBILITY`

`CARE_PROPOSAL_REQUIRES_HUMAN_APPROVED_PRICE`
...
| GS-SALES-004 | Proposal Send & Next-Step Email | Approved proposal ready to send | AI-produced first draft | Human review before send |\n| GS-SALES-005 | Templated WordPress Proposal | Approved productized route, scope, current pricing, and add-ons | AI-produced first draft | Human commercial approval |\n| GS-SALES-006 | Personalized SimpliCARE Proposal | Approved CARE responsibility, scope, cadence, and price | AI-produced first draft | Human commercial approval |
