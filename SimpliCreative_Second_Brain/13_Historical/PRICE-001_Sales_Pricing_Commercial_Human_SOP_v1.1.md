SimpliCreative Sales, Pricing & Commercial Human SOP

Version: 1.1

Classification: Human Delivery & Commercial Governance SOP
...
Related Specification: PRICE-002\_SimpliCreative\_Sales\_Pricing\_and\_Commercial\_Intelligence\_Workflow\_Spec\_v1.0.docx
...
Applies To: Qualification, offer routing, commercial readiness, proposal readiness, Foundation scoping, pricing, proposals, agreements/SOW handoff, scope changes, profitability validation, opportunity progression, Closed Won evidence, and delivery activation
...
CURRENT\_PRICING\_OVERRIDES\_HISTORICAL\_PRICING  
 COMPANY\_SIZE\_DOES\_NOT\_DETERMINE\_OFFER  
 ...
 HOURS\_VALIDATE\_ECONOMICS. HOURS\_DO\_NOT\_DEFINE\_CLIENT\_VALUE.  
 AI\_MAY\_RECOMMEND\_PRICE. HUMAN\_APPROVES\_PRICE.  
 MISSING\_PRICING\_DOES\_NOT\_AUTHORIZE\_AI\_TO\_INVENT\_PRICE  
 HISTORICAL\_PROPOSAL\_DOES\_NOT\_OVERRIDE\_CURRENT\_PRICING  
 CLIENT\_SPECIFIC\_DISCOUNT\_DOES\_NOT\_BECOME\_AGENCY\_PRICING
...
# **29\. Commercial Workflow Boundary**

This SOP governs the human commercial process after an opportunity has an approved route and sufficient evidence to advance.

The Diagnostic determines fit, route, and readiness.

This SOP governs how SimpliCreative turns an approved route into an appropriate commercial action.
...
ROUTE\_DECISION \!= COMMERCIAL\_READINESS  
 COMMERCIAL\_READINESS \!= PROPOSAL\_READINESS  
 PROPOSAL\_SENT \!= ACCEPTED  
 VERBAL\_INTEREST \!= CLOSED\_WON

# **30\. Determine Commercial Readiness**

Commercial readiness asks whether there is enough alignment and buying context to responsibly advance the opportunity.

Consider:

The prospect understands the recommended engagement.

The business problem and desired outcome are sufficiently clear.

The prospect understands what the engagement will and will not do.

Decision authority is known or sufficiently understood.

Relevant stakeholders are identified.

Timing is known enough to advance.

Known budget or economic constraints do not obviously invalidate the route.

Material objections or trust concerns are understood.

Required information for the next commercial step is available or has a clear owner.

Commercial readiness should be recorded as:

READY  
 DEVELOPING  
 NOT\_READY

A prospect may be strategically appropriate and still not be commercially ready.

Do not manufacture urgency to move the opportunity forward.

# **31\. Determine Proposal Readiness**

Proposal readiness asks whether SimpliCreative has enough approved information to put a specific engagement in front of the prospect.

A proposal may be generated only when:

The human-approved route exists.

Commercial readiness is sufficient for the intended action.

The applicable offer is current and approved.

Required scope is known.

Required pricing inputs are current.

Any required scoping is complete.

Any required pricing or margin review is complete.

The recommended commercial terms are approved.

Open items that would materially change scope or price are resolved or explicitly disclosed.
...
PROPOSAL\_REQUEST \!= PROPOSAL\_READINESS  
 ...
 AI\_DRAFT \!= PROPOSAL\_APPROVAL

# **32\. Use Foundation Scoping When Custom Implementation Must Be Defined**

Direct-to-Foundation and post-Blueprint Foundation opportunities may require a formal Foundation Scoping step before a fixed SimpliFoundation proposal can be issued.

Foundation Scoping determines how an already-established strategy should be implemented.

It should establish, where applicable:

Implementation responsibilities.

Information architecture and page scope.

Content responsibility.

Messaging and editorial scope.

Custom UX and visual design scope.

CMS and development scope.

Forms and CRM requirements.

Analytics and measurement requirements.

SEO, AEO, GEO, and schema requirements.
...
Foundation Complexity Assessment.

Deliverable reference-value validation.

Delivery economics.

Margin validation.

Recommended fixed investment.

Use the Foundation Scoping Record as the internal source for these decisions.

FOUNDATION\_SCOPING \!= BLUEPRINT  
 FOUNDATION\_SCOPING \!= PROPOSAL  
 FOUNDATION\_SCOPING \= IMPLEMENTATION\_AND\_COMMERCIAL\_DEFINITION

If Foundation Scoping reveals material strategic uncertainty, return the issue to strategic review instead of quietly resolving strategy inside pricing.

# **33\. Prepare the Proposal From Approved Inputs**

A proposal is a commercial expression of approved decisions.

It should not be the place where scope, strategy, or pricing is invented.

Current approved Gold-Standard proposal examples include:

GS-SALES-001 Personalized SimpliBlueprint Proposal.

GS-SALES-002 Personalized SimpliFoundation Proposal.

A client-facing proposal may contain, where appropriate:

Client objective.

Relevant context from the approved Diagnostic or strategic source.

Recommended engagement.

Why that engagement is appropriate.
...
Approved timing or scheduling language.

Next steps.

For proposals that require a fixed Foundation investment, use the human-approved price from the Pricing Decision Record.

Do not expose internal complexity scores, internal pricing bands, deliverable reference values, estimated labor, loaded costs, delivery cost, gross margin, or AI confidence.

# **34\. Send the Proposal With a Clear Next Step**

After a proposal is approved for issuance, use a concise proposal-send / next-step communication.

The email should:

Reference the approved proposal.

Reinforce the client objective and approved route.

State the approved investment only when the proposal contains that investment.

Explain the immediate next step.

Preserve any agreed commitments.

Avoid repeating the entire proposal.

Avoid artificial urgency.

The current Gold Standard is:

GS-SALES-004 Proposal Send & Next-Step Email.

PROPOSAL\_EMAIL\_MUST\_TRACE\_TO\_APPROVED\_PROPOSAL  
 PROPOSAL\_EMAIL\_MUST\_NOT\_INVENT\_PRICE\_TERMS\_OR\_TIMELINE  
 HUMAN\_COMMERCIAL\_REVIEW\_REQUIRED\_BEFORE\_SEND

# **35\. Maintain the Commercial Record After Proposal**

A proposal is an event, not the end of the sales process.

After proposal issuance, preserve the material commercial state.
...
Recipient and relevant stakeholders.
...
Agreement / SOW status.

Final outcome.

Reason for win, loss, delay, or no-decision when known.

Do not treat politeness as commitment.

Do not treat a verbal expression of interest as acceptance.

# **36\. Use Controlled Agreement / SOW Templates**

The agreement or SOW should come from a controlled commercial or legal template.

AI may populate approved fields from the approved proposal, Pricing Decision Record, and current commercial terms.

AI may not author or modify legal language without explicit human/legal authorization.

AI may not invent payment terms.

AI may not silently resolve a conflict between the proposal and agreement.

When material terms conflict, stop and return:

PROPOSAL\_AGREEMENT\_CONFLICT\_REQUIRES\_HUMAN\_REVIEW

Before the agreement is issued, confirm that the approved scope, price, payment terms, timing language, client entity, and material responsibilities match the current commercial decision.

# **37\. Closed Won and Delivery Activation**

An opportunity should not become Closed Won merely because the prospect is enthusiastic or verbally agrees.

Closed Won requires approved source evidence according to the current commercial process.

At minimum, the system should be able to establish:

The correct agreement / SOW was issued.

Required signature evidence exists.

The approved activation condition has been satisfied.

Required commercial approvals are complete.

The final amount and engagement match the approved commercial record.

Any material exceptions are documented.
...
Only after the approved Closed Won / activation conditions are satisfied should delivery activation occur.

# **38\. Commercial Output Checklist**

Use this checklist to distinguish governed outputs from internal system records.

| ID / Record | Output | Audience | Production Model | Human Approval | Format |
| :---- | :---- | :---- | :---- | :---- | :---- |
| System Record | Commercial / Proposal Readiness State | Internal | AI-assisted, human-led | Required | Structured record |
| GS-SALES-003 | Foundation Scoping Record | Internal | AI-assisted structured scoping | Required before Foundation pricing/proposal | XLSX |
| System Record | Pricing Decision Record | Internal | AI-assisted calculation and recommendation | Required for material/custom pricing | Structured record |
| GS-SALES-001 | Personalized SimpliBlueprint Proposal | Client | AI-produced first draft from approved inputs | Required before send | DOCX |
| GS-SALES-002 | Personalized SimpliFoundation Proposal | Client | AI-produced first draft from approved scope and price | Required before send | DOCX |
| GS-SALES-004 | Proposal Send & Next-Step Email | Client | AI-produced first draft from approved proposal | Required before send | Email / DOCX sample |
| Controlled Template | Agreement / SOW | Client / Legal | AI may populate approved fields only | Required | Controlled contract template |
| System Record | Proposal Record | Internal | AI-assisted structured write-back | Human validates material state changes | Structured record |
| System Record | Commitment Record | Internal | AI-assisted extraction from evidence | Human validates material commitments | Structured record |
| System Record | Opportunity / CRM Record | Internal | Approved write-back | Human/commercial authority for material stage changes | CRM / structured record |
| System Event | Closed Won / Activation Record | Internal | AI may document supported event | Human-approved evidence required | Structured event |

 

The existence of a standard output does not mean it should be generated for every opportunity.

The approved route, readiness state, scope, and current commercial inputs determine which outputs are required.

# **39\. Sales, Pricing & Commercial Non-Negotiables**
...
CURRENT\_PRICING\_OVERRIDES\_HISTORICAL\_PRICING  
 ...
 PROPOSAL\_REQUEST \!= PROPOSAL\_READINESS  
 DIRECT\_TO\_FOUNDATION \!= FOUNDATION\_PROPOSAL\_READY  
 FOUNDATION\_PRICE\_REQUIRES\_SCOPING\_AND\_HUMAN\_APPROVAL  
 CLIENT\_BUDGET\_DOES\_NOT\_JUSTIFY\_UNCHANGED\_SCOPE\_DISCOUNT  
 HOURS\_VALIDATE\_ECONOMICS. HOURS\_DO\_NOT\_DEFINE\_CLIENT\_VALUE.  
 AI\_MAY\_RECOMMEND\_PRICE. HUMAN\_APPROVES\_PRICE.  
 AI\_MAY\_DRAFT\_PROPOSAL. HUMAN\_APPROVES\_PROPOSAL.  
 AI\_MAY\_POPULATE\_CONTROLLED\_AGREEMENT\_FIELDS.  
 AI\_MAY\_NOT\_AUTHOR\_LEGAL\_TERMS.  
 PROPOSAL\_SENT \!= ACCEPTED  
 VERBAL\_INTEREST \!= CLOSED\_WON  
