...
Version: 1.1 Classification: Knowledge Governance Status: Active
...
## 9. Blueprint Sources
  ...
  **Source   **Source**              **Status**                **Authority   **Ingestion**
  ID**                                                         Domain**      
  ---------- ----------------------- ------------------------- ------------- ---------------
  BLUE-001   SimpliBlueprint Human   CURRENT_SOURCE_OF_TRUTH   Blueprint     Yes
             SOP                                               Delivery      

  BLUE-002   Blueprint Intelligence  CURRENT_SOURCE_OF_TRUTH   Blueprint AI  Yes
             Workflow Spec                                     Workflow      

  BLUE-003   Blueprint Strategy Deck CURRENT_SOURCE_OF_TRUTH   Blueprint     Yes
             Spec                                              Deliverable   
  ------------------------------------------------------------------------------------------
...
## 11. CARE Sources
  ...
  **Source   **Source**                  **Status**                **Authority    **Ingestion**
  ...
  CARE-002   CARE Intelligence &         CURRENT_SOURCE_OF_TRUTH   CARE           Yes
             Reporting Engineering Spec                            Intelligence   
  -----------------------------------------------------------------------------------------------

CARE should preserve metric definitions, comparability, evidence, and
decision trace.
